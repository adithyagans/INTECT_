...
toilet -f big -F gay "INTECT_" 

echo "" 

echo "\033[32;1mAuthor : INTECT_" 

echo "\033[35;1mTeam : W3LL SQUAD"

echo "\033[33;1mKontak Me : 081911226887"

echo "\033[31;1mSubcribe Youtube:"

echo "\033[33;1mW3LL SQUAD" "\033[32;1m&" "\033[36;1mSUNDA CYBER ARMY"
...
echo "\033[32;1mSok mank diPilih Tools Yang mau lu gunain:)?:"
...
toilet -f standard -F gay "INTECT_" 
...
cowsay -f kiss.cow "INTECT_" | lolcat

figlet -f slant INTECT_
...
cowsay -f sheep.cow "INTECT_" | lolcat
...
echo "\033[33;1mTeam: W3LL SQUAD"

echo "\033[34;1mHALLU CYBER TEAM"

echo "\033[32;1mSUNDA CYBER ARMY"
...
cowsay ghostbusters.cow "INTECT_" 
...
toilet -f standard -F gay "INTECTganss!!"
...
toilet -f big -F gay "INTECT_ " | lolcat
...
echo "\033[32;1mW3LL SQUAD"

sleep 1

echo "\033[33;1mWe TESTER"
...
echo "Happy hacking and enjoy your life;)"

sleep 1

echo "Ketika Kamu gagal"

sleep 1

echo "Berusahalah,coba dan coba lagi:)"

sleep 1

echo "\033[32;1mKarena usaha tidak akan menghianati hasil:)"
